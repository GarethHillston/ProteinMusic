...
public class Input {
    ...
    public void parseInput(String fileName) {
        ...
        // Read in only A,C,G or T character, into an array. Every third 
        // character, generate a new codon using the previous three characters
        // and add that to the 'bass' array.
        try {
            int i = 0;
